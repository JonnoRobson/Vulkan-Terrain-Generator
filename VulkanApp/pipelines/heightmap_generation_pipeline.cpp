#include "heightmap_generation_pipeline.h"
#include "../terrain_generator.h"

void HeightmapGenerationPipeline::RecordCommands(VkCommandBuffer& command_buffer)
{
	// bind the pipeline
	...
	VkExtent2D image_extent = { TERRAIN_SIZE, TERRAIN_SIZE };
